	...
	<div class="d-flex flex-row h-100">
		...
		<div class="flex-grow-1">
            ...
            <div class="p-4">
                ...
                <button type="button" class="btn btn-primary btn-sm ms-4" onclick="newMenuItem()">New menu item</button>

                <button type="submit" class="btn btn-primary btn-sm" onclick="document.getElementById('menu-items-container').submit()">Save</button>
                ...
                <script>
                    ...
                    window.newMenuItem = function () {
                        ...
                        html += '<input type="text" class="form-control form-control-sm me-2" name="menu-item-' + window.menuItemsCounter + '"/>';
                        html += '<button type="button" class="btn btn-danger btn-sm me-2" onclick="deleteMenuItem(' + window.menuItemsCounter + ')">Delete</button>';
                        html += '</div>';
                        html += '<div id="container-menu-item-' + window.menuItemsCounter + '">';
                        html += '</div>'
                        html += '<button type="button" class="btn btn-primary btn-sm ms-5 mb-2" onclick="newField(this.previousElementSibling, ' + window.menuItemsCounter + ')">New field</button>';
                    ...
                    window.newField = function (parent, menuItemCounter) {
                        ...
                        let newNode = document.createElement('div');
                        newNode.classList.add('d-flex', 'mb-2', 'align-items-center', 'ms-5');

                        let html = '';

                        html += '<input type="text" class="form-control form-control-sm me-2" style="width: 200px" name="' + nodeName + '"/>';
                        html += '<input class="form-check-input me-1" type="checkbox" name="' + nodeRequired + '"/><label class="form-check-label me-2">Required</label>';
                        html += '<input class="form-check-input me-1" type="checkbox" name="' + nodeUnique + '"/><label class="form-check-label me-2">Unique</label>';
                        ...
                        html += '<option value="">Input type ...</option>';
                        ...
                        html += '<button type="button" class="btn btn-danger btn-sm me-2" onclick="deleteField(this.parentNode)">Delete</button>';
